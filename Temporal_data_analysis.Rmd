...
### 2. Seasonal Analysis: Average Daily Collisions
...
p2 <- seasonality_df |> 
  ...
  # Move legend to bottom or top since it's now crucial for identifying the bars
...
### 3. Diurnal Analysis: Hourly Trends
...
The data suggests a "Volume-Based Risk" model: collisions are most frequent when the city is most alive—during the evening rush hours, in the warmer autumn months, and in the years following the return of regular economic activity. The parallel trends between **Minor** and **Medium** incidents suggest that interventions aimed at simply reducing overall traffic volume or congestion during peak hours (4 PM - 6 PM) and peak months (September/October) could effectively reduce both nuisance accidents and injury-causing crashes simultaneously.