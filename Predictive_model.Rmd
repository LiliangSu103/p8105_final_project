...
We begin by loading the cleaned dataset (the cleaning process is documented [here](data_clean.html)), aggregating it to the daily level, and constructing all predictor variables, including time-based features, lagged collision counts, and lagged casualty counts.
