...
# This creates one clean row per person.
collision_df = person_df |>
  # start with ALL persons. Join crash details.
  left_join(crash_df, by = "collision_id") |>
  # add vehicle details. This join handles occupants (non-NA vehicle_id match) and pedestrians (NA vehicle_id, resulting in NA vehicle columns) correctly.
